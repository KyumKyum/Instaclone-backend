...
export const typeDefs = mergeTypeDefs(loadedTypes); //Merge all loaded type definitions.
export const resolvers = mergeResolvers(loadedResolvers); //Merge all loaded resolvers.
